...
class AuthorityApp extends StatelessWidget { const AuthorityApp({super.key}); @override Widget build(BuildContext context) => MaterialApp(title: 'EU Data Compass Authority', theme: ThemeData(colorSchemeSeed: const Color(0xff174ea6), useMaterial3: true), home: const AuthorityHome()); }
