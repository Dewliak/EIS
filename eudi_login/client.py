...
class EUDIWalletLogin:
    ...
    def _render_page_style() -> None:
        ...
        st.markdown(
            ...
            <style>
              ...
              .eudi-lead { color: #45546f; font-size: 1.12rem; line-height: 1.65; max-width: 36rem; }
              .eudi-points { display: grid; gap: .8rem; margin-top: 2.1rem; }
              .eudi-point { color: #243451; font-size: .98rem; }
              ...
              .eudi-card-copy { color: #61708b; font-size: .92rem; line-height: 1.5; margin: 0 auto 1rem; max-width: 18rem; }
    ...
    def _render_login_page(self, transaction: dict) -> None:
        ...
        with intro:
            st.markdown('<div class="eudi-brand">🇪🇺 EIS · European Impact Sprints</div>', unsafe_allow_html=True)
